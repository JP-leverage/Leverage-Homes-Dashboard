...
function VpFocus({ store, dir, org, range, rangeFwd, drillLabel, results }) {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      {perVp.length > 0 && (
        <div style={{ maxWidth: 320 + vps.length * 168, margin: "0 auto", width: "100%" }}>
