    ...
    <div className="flex flex-col gap-5">
      <div className="flex flex-col gap-2.5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
          ...
          <VpStat label="Deals → ARIP" value={b.arips.toLocaleString()} sub="opps entered ARIP" />
          <VpStat label="Deals Out of ARIP" value={rv("arip_dealreview")} />
      ...
      <div className="flex flex-col gap-2.5">
        <SubHead label="Activity & other" note="calls, contracts & lead flow" />
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
          <VpStat label="Contracts Sent" value={b.contracts.toLocaleString()} />
          <VpStat label="Talk Time" value={fmt(b.calls.minutes, "minutes")} sub={`${b.calls.calls.toLocaleString()} outbound calls`} />
          <VpStat label="QCs" value={b.calls.qcs.toLocaleString()} sub={`avg call ${fmtDur(b.calls.avgSec)}`} />
          <VpStat label="Deals Closed" value={rv("deals_closed")} />
