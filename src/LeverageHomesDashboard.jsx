...
function UnderwritingView({ store, range, dir, org }) {
  ...
  const acc = useMemo(() => {
    ...
    accRows.forEach((r) => {
      ...
      const dated = c ? inRange(c.closeDate) : !range; if (!dated) return; // no close-date match → All-time only
