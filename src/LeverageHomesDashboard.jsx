  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2.5">
        <SubHead label="Output" note="conversion, contracts, calls & revenue" />
      ...
      {extraTiles && <div className="flex flex-col gap-2.5" style={{ breakBefore: "page", pageBreakBefore: "always" }}>
        <SubHead label="More metrics" note="results & pipeline health not shown above" />
        {extraTiles}
      </div>}
